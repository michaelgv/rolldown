        ...
        value: function runRoute(route) {
            ...
            if (this._current_route === null) {
                if (typeof this._default_route.component === 'function' && typeof this._default_route.component.getDescription !== 'undefined') // exported class
                    {
                        var componentNode = new this._default_route.component();
                        typeof componentNode.willRender !== 'undefined' ? componentNode.willRender() : '';
                        componentNode.render();
                    } else {
        ...
        value: function findDefault() {
            ...
            this._routes.forEach(function (route) {
                if (typeof route.default !== 'undefined' && route.default) {
                    _this2._default_route = route;
                }
            });
        }
    }, {
        key: 'findPredefinedRoute',
        value: function findPredefinedRoute() {
...
var diffDOM = createCommonjsModule(function (module, exports) {
...
var diffDOM_1 = diffDOM.diffDOM;

var RxComponent = function () {
	createClass(RxComponent, null, [{
		key: 'getDescription',
	...
	function RxComponent() {
		classCallCheck(this, RxComponent);
	...
	createClass(RxComponent, [{
		key: 'createState',
		value: function createState(stateName, stateValue, stateBinder) {
		...
		key: 'qSelect',
		value: function qSelect(tag, live) {
		...
		key: 'qCommit',
		value: function qCommit() {
			var dd = new diffDOM();
			var diff = dd.diff(this.template, this.templateVREP);
			dd.apply(this.template, diff);
		}
	}, {
		key: 'setState',
		value: function setState(stateProp, stateVal) {
		...
		key: 'loadTemplate',
		value: function loadTemplate(templateVREP) {
		...
		key: 'eventNotice',
		value: function eventNotice(details) {
			if (_typeof(this['event' + details.bindAction])) {
				this['event' + details.bindAction](details);
			}
		}
	}, {
		key: 'bindStateToVrep',
		value: function bindStateToVrep(stateAction, selector) {
		...
		key: 'shouldUpdate',
		value: function shouldUpdate(statefulItem) {
			var _hasVrep = statefulItem.vrep !== null;
			if (_hasVrep) {
				...
				console.log("WARNING: You cannot trigger shouldUpdate on a state without a virtual representation binding. In order to bind an item, you need to define a binder. Read more: https://rolldown.js.org/guide/binders#vrep-binding");
			}
		}
	}, {
		key: 'render',
...
var Commiter = function () {
    createClass(Commiter, [{
        key: 'commiterObject',
        value: function commiterObject() {
            var CommiterObject = {
                states: [],
                modules: []
            };
    ...
    function Commiter(origin, scope) {
        classCallCheck(this, Commiter);
    ...
    createClass(Commiter, [{
        key: 'commit',
        value: function commit(action, value, origin) {
        ...
        key: 'createCommit',
        value: function createCommit(action, defaultValue, originalBinder) {
        ...
        key: 'shouldUpdate',
        value: function shouldUpdate(action) {
            window.gcommiter.modules.forEach(function (stateModule) {
        ...
        key: 'addToScope',
        value: function addToScope(origin) {
...
var Example = function (_RxComponent) {
    inherits(Example, _RxComponent);

    function Example() {
        classCallCheck(this, Example);

        var _this = possibleConstructorReturn(this, (Example.__proto__ || Object.getPrototypeOf(Example)).call(this));

        _this.commiter = new Commiter(_this);
        _this.loadTemplate(_this.genExampleTemplate());
        setTimeout(function () {
            _this.qSelect('#ptest > span').innerText = " ..... Changed after 1 seconds successfully";
            _this.qCommit();
            _this.commiter.createCommit('test', 'metoo', _this);
            setTimeout(function () {
                return _this.commiter.commit('test', 'newtest', _this);
            }, 2000);
        }, 1000);
        return _this;
    }
    ...
    createClass(Example, [{
        key: 'eventtest',
        value: function eventtest() {
            alert('eventtest called');
        }
    }, {
        key: 'genExampleTemplate',
        value: function genExampleTemplate() {
